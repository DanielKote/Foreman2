...
namespace Foreman {
    public partial class PresetSelectionForm : Form {
        ...
        public Preset? ChosenPreset { get; set; }
        ...
        public PresetSelectionForm(List<PresetErrorPackage> presetErrors) {
            ...
            PresetSelectionListView.Columns[^1].Width = 1;
            ...
            foreach (PresetErrorPackage pePackage in presetErrors) {
                ...
                [
                    ...
                    compatibility[0].ToString("%00", DisplayCulture.Format),
                    compatibility[1].ToString("%00", DisplayCulture.Format),
                    compatibility[2].ToString("%00", DisplayCulture.Format)
                ]);
                PresetSelectionListView.Items.Add(presetItem);
                presetItem.ToolTipText =
                    string.Format(DisplayCulture.Format, "Mods:\n") +
                    ...
                    string.Format(DisplayCulture.Format, "     ({0}) Incorrect", (pePackage.IncorrectRecipes.Count));
            }
        }
