...
namespace Foreman
{
	public abstract partial class IRChooserForm : Form
	{
		...
		public IRChooserForm(ProductionGraphViewer pgviewer)
		{
			PGViewer = pgviewer;
		...
		private void IRChooserForm_Shown(object sender, EventArgs e)
		{
		...
		private void IRChooserForm_FormClosed(object sender, FormClosedEventArgs e)
		{
		...
		private void IRChooserForm_Deactivate(object sender, EventArgs e)
		{
			Close();
		}
		...
		private void IRChooserForm_VisibleChanged(object sender, EventArgs e)
		{
			if(!this.Visible)
			{
	...
	public class ItemChooserForm : IRChooserForm
	{
		...
		public ItemChooserForm(ProductionGraphViewer parent) : base(parent) { }

		public void Show(Point originPoint, Action<Item> callback, Action endAction = null)
		{
			CallbackMethod = callback;
			EndAction = endAction;

			Rectangle screenBounds = Screen.FromControl(this).Bounds;
			this.Left = Math.Max(50, Math.Min(screenBounds.Width - this.Width - 50, originPoint.X));
			this.Top = Math.Max(50, Math.Min(screenBounds.Height - this.Height - 50, originPoint.Y));
			SetSelectedGroup(null);
			//this.Height = tableLayoutPanel1.Height + 48;
			UpdateIRButtons(0, false);
			Show();
			Focus();
			FilterTextBox.Focus();
		}
	...
	public class RecipeChooserForm : IRChooserForm
	{
		...
		public RecipeChooserForm(ProductionGraphViewer parent) : base(parent) { }

		public void Show(Point originPoint, Item item, fRange tempRange, bool includeSuppliers, bool includeConsumers, Action<NodeType, Recipe> callback, Action endAction = null)
		{
			CallbackMethod = callback;
			EndAction = endAction;
