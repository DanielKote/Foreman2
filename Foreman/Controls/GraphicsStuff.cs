            ...
            for (int r = 0; r < recipes.Count; r++) {
                ...
                for (int i = 0; i < maxIngredientCount; i++) {
                    if (i < recipes[r].IngredientList.Count) {
                        ...
                        //graphics.DrawRectangle(devPen, textbox);
                        graphics.DrawString(recipes[r].IngredientSet[ingredient].ToString("0.##", DisplayCulture.Format) + "x", QuantityFont, TextBrush, new Point(52 + xOffset, 20 + yOffset));
                ...
                for (int i = 0; i < maxProductCount; i++) {
                    if (i < recipes[r].ProductList.Count) {
                        ...
                        textbox = new Rectangle(xOffset + 52, yOffset + 2, SectionWidth - 58, 20);
                        //graphics.DrawRectangle(devPen, textbox);
                        graphics.DrawString(recipes[r].ProductSet[product].ToString("0.##", DisplayCulture.Format) + "x", QuantityFont, TextBrush, new Point(52 + xOffset, 20 + yOffset));
                ...
                graphics.FillRectangle(DarkBackgroundBrush, new Rectangle(xOffset, yOffset, SectionWidth, 22));
                yOffset += 2;
                graphics.DrawString("Crafting Time: " + recipes[r].Time.ToString("0.##", DisplayCulture.Format) + " s", SectionFont, TextBrush, 4 + xOffset, 0 + yOffset);
